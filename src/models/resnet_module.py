...
from torchmetrics.classification import (
    Accuracy, AUROC, Specificity, Recall, F1Score)
...
class ResNetLitModule(LightningModule):
    ...
    def __init__(
        ...
        num_classes = self.net.num_outputs
    ...
    def training_step(
        ...
        self.log("train/F1", self.train_f1, on_step=False,
                 on_epoch=True, prog_bar=True)
        self.log("train/AUC", self.train_auc, on_step=False,
                 on_epoch=True, prog_bar=True)
    ...
    def validation_step(self, batch: Tuple[torch.Tensor, torch.Tensor], batch_idx: int) -> None:
        ...
        self.log("val/F1", self.val_f1, on_step=False,
                 on_epoch=True, prog_bar=True)
        self.log("val/AUC", self.val_auc, on_step=False,
                 on_epoch=True, prog_bar=True)
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        self.log("val/F1_best", self.val_f1_best.compute(),
                 sync_dist=True, prog_bar=True)
        self.log("val/AUC_best", self.val_auc_best.compute(),
                 sync_dist=True, prog_bar=True)
